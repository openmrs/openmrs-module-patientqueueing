...
<div class="action-section">
    <h3 style="text-align: center; color: black"><span style="color: red;">${alerts.size()}</span> ${ui.message("patientqueueing.alertmessages.title.label")}</h3>
...
<div id="read_message" class="dialog" style="display: none">
    ...
    <div>
        ...
        <div class="dialog-content form">
            <button class="cancel" id="">${ui.message("patientqueueing.close.label")}</button> <button class="confirm" id="okay">${ui.message("patientqueueing.ok.label")}</button>
        </div>
    </div>
</div>
...
<div id="create_message" class="dialog" style="display: none">
    ...
    <div>
        ...
        <div class="dialog-content form">
            <button class="cancel" id="">${ui.message("patientqueueing.cancel.label")}</button> <button class="confirm" id="okay">${ui.message("patientqueueing.send.label")}</button>
        </div>
    </div>
</div>